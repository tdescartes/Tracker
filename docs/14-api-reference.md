...
```json
{
  "month": "2026-02",
  "total_spent": 412.50,
  "confirmed_spent": 312.50,
  "estimated_spent": 100.00,
  "budget_limit": 600.00,
  "remaining": 187.50,
  "by_category": { "Groceries": 285.00, "Dairy": 45.50 },
  "bank_category_breakdown": { "Dining": 62.00, "Transport": 38.00 },
  "waste_cost": 28.50,
  "daily_pace": 17.18,
  "on_track": true
}
...
```json
{
  ...
  "expenses": 2860.00,
  "net": 340.00,
  "vs_last_month_expenses": 120.00,
  "vs_last_month_pct": 4.4,
  "biggest_increase_category": "Dining",
  "biggest_increase_amount": 42.00,
  "category_breakdown": { "Groceries": 285.00, "Dining": 162.00 },
  "subscriptions": [
    { "description": "Netflix", "amount": 15.99, "months_seen": 1 }
  ],
  "subscription_monthly_total": 87.00,
  "subscription_annual_total": 1044.00,
  "surplus": 340.00
}
```
